...
final class ReserveRegistrationTest extends WebTestCase
{
    ...
    public function testPrivateEventIsNotEligible(): void
    {
        ...
        $event = $this->createEvent(Event::STATUS_PUBLISHED, isPublic: false);
    ...
    public function testFullEventReturns409(): void
    {
        ...
        $event = $this->createEvent(Event::STATUS_PUBLISHED, capacity: 1);

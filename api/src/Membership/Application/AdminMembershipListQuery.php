...
final readonly class AdminMembershipListQuery
{
    ...
    private function applyStatusFilter(\Doctrine\DBAL\Query\QueryBuilder $qb, ?string $status, string $now): void
    {
    ...
    private function applyCommonFilters(\Doctrine\DBAL\Query\QueryBuilder $qb, ?string $search, ?string $userId, ?string $dateFrom, ?string $dateTo): void
    {

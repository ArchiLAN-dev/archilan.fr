...
Verified live: `/runs-hebdo/{id}/ma-run?tab=items` renders both panels
("Items reçus (7)" + "Items non reçus (97)") with filter + per-item counts.

- File: `frontend/src/features/weekly-runs/weekly-run-slot-page.tsx` (modified)
- Gates: pnpm typecheck / lint / build green.

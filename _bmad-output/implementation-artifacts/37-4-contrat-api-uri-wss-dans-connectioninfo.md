...
- [ ] **Task 0**. Trancher le nom d'hôte (voir ci-dessus) et le consigner dans le Change Log de la
  story. Vérifier qu'il correspond au `domains` de 37.2 et au banc de 37.6.
- [ ] **Task 1** (AC 1-4). Écrire le composant de dérivation et ses tests unitaires.
- [ ] **Task 2** (AC 5). Sessions.
- [ ] **Task 3** (AC 6). PersonalRuns.
- [ ] **Task 4** (AC 7-8). WeeklyRuns, les deux chemins, plus les doubles.
- [ ] **Task 5** (AC 9). Communications.
- [ ] **Task 6** (AC 10-12). Contrôle d'architecture, mise à jour des tests, `composer gates`.
